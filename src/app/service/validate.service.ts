...
export class ValidatorService {
  ...
  subDetails = [
    ...
    },
    {
      id:4,
      subName:"Engineering",
      subDetails:"Engineering is the application of science and maths to solve problems. While scientists and inventors come up with innovations, it is engineers who apply these discoveries to the real world.",
      ...
      subImg2:"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQJsS6cE95FDfo0GWHJVQXdrhoaD5sV48Kacg&usqp=CAU"
    },
    {
      id:5,
      subName:"Innovation",
